...
const Reviews = () => {
  return (
    <>
    <div class=" mx-auto text-center md:max-w-xl lg:max-w-3xl pt-12">
  <h1
    class="mb-6 text-2xl lg:text-6xl tracking-tight font-extrabold ">
    Testimonials
  </h1>
  <p class="mb-6 pb-2 text-lg md:mb-12 md:pb-0">
...
<div class="grid gap-6 text-center mb-14 md:grid-cols-3 lg:gap-12">
