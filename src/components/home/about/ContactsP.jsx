            ...
            <section class="bg-white ">
                ...
                <div class="py-8 px-4 mx-auto max-w-screen-xl lg:py-16 lg:px-6 ">
                    <div class="mx-auto max-w-screen-sm text-center mb-8 lg:mb-16">
                        <h1 className="text-2xl lg:text-6xl tracking-tighter md:leading-snug f-f-l font-black"><span className='text-vorreiter'>Contact</span> Us</h1>
                        <p class=" mt-3 text-black lg:mb-16 sm:text-xl dark:text-black"> Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eius
                            tempor incididunt ut labore et dolore magna aliqua. Ut enim adiqua
                            minim veniam quis nostrud exercitation ullamco</p>
                    </div>
                    <div class=" grid  sm:grid-cols-3  gap-4 justify-center items-center  ">
                        <div class="bg-white  shadow-xl items-center  max-w-2xl flex flex-col sm:flex-row gap-3 sm:items-center  justify-between px-5 py-4 rounded-md">
